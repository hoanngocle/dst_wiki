        ...
        <div className="relative">
          ...
          {query ? (
            <button
              ...
              className="absolute right-3 top-1/2 inline-flex min-h-10 -translate-y-1/2 items-center gap-1 rounded-lg px-2 py-1 text-sm text-[#53647a] transition hover:bg-[#e9eff6] active:scale-[0.98]"
            >
