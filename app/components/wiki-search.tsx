    ...
    <section aria-labelledby="atlas-results" className="mt-8">
      <div className="relative">
        ...
        <div className="relative">
          ...
          />
          {query ? (
            <button type="button" onClick={clearQueryAndFocus} aria-label="Clear search" className="absolute right-3 top-1/2 inline-flex min-h-10 -translate-y-1/2 items-center gap-1 rounded-md px-2 py-1 text-sm text-[#53647a] hover:bg-[#e9eff6] active:scale-[0.98]">
