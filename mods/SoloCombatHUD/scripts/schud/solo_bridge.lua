...
function Bridge.install_text(resolver)
    ...
    if utils._schud_original_spawn_text ~= nil then return true end

    local original = utils.SpawnClientStrFx
    utils._schud_original_spawn_text = original
    ...
    if type(utils.SpawnClientLevelUpFx) == "function" and utils._schud_original_level_text == nil then
        local level_original = utils.SpawnClientLevelUpFx
        utils._schud_original_level_text = level_original
