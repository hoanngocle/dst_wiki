...
local perks = {
    ...
    { id = "ancient_builder", group = "craft", name = "Ancient Builder", price = 15 },
    { id = "lunar_knight", group = "craft", name = "Kỵ Sĩ Ánh Trăng", price = 10 },
    { id = "pearl_bff", group = "craft", name = "Pearl BFF", price = 8 },
    { id = "benevolent_mind", group = "craft", name = "Benevolent Mind", price = 8 },
    { id = "mad_scientist", group = "craft", name = "Nhà Khoa Học Điên", price = 10 },
    { id = "celebrate", group = "craft", name = "Celebrate!", price = 5 },
    { id = "festive", group = "craft", name = "Festive!", price = 5 },
    { id = "christmas_gift", group = "craft", name = "Quà Giáng Sinh", price = 8 },
    { id = "legendary_smith", group = "craft", name = "Thợ Rèn Huyền Thoại", price = 15 },
    { id = "pokeball", group = "craft", name = "Pokeball", price = 12 },
    { id = "antique_shop", group = "craft", name = "Antique Shop", price = 8 },
    {
