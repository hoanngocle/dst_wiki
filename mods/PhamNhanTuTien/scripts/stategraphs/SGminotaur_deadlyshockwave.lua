...
local __BU_g_ = {}
local _Bu_g__ = {"INLIMBO", "notarget", "noattack", "invisible", "playerghost", "minotaur", "shadowcreature"}
local b_u__g = {
    State {
        name = "idle",
        tags = {"idle"},
        ...
        timeline = {
            TimeEvent(
                ...
                function(_B__u_g__)
                    ...
                    _B__u_g__["components"]["combat"]:DoAreaAttack(
                        _B__u_g__,
                        TUNING["MINOTAUR_DSW_RANGE"],
                        nil,
                        nil,
                        nil,
                        _Bu_g__
...
return StateGraph("minotaur_deadlyshockwave", b_u__g, __BU_g_, "idle")
