...
local function SpawnEffect(inst)
    ...
    SpawnPrefab("ttk_boss_spider_puff_back").Transform:SetPosition(x, y - .1, z)
    SpawnPrefab("ttk_boss_spider_puff_front").Transform:SetPosition(x, y, z)
end
        ...
        timeline=
        {
            ...
            TimeEvent(25*FRAMES, function(inst)
                ...
                if target and target:IsValid() and not
                    ...
                    local x,y,z = inst.Transform:GetWorldPosition()
                    local proj = SpawnPrefab("ttk_boss_spider_pro")
...
return StateGraph("ttk_boss_spider", states, events, "idle", actionhandlers)
