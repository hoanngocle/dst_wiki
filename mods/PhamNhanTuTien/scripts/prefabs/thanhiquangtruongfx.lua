...
local TEXTURE = resolvefilepath("fx/thanhiquangtruongfx.tex")
local SHADER = "shaders/vfx_particle.ksh"

local COLOUR_ENVELOPE_NAME = "thanhiquangtruong_colourenvelope"
local SCALE_ENVELOPE_NAME = "thanhiquangtruong_scaleenvelope"
...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(COLOUR_ENVELOPE_NAME..0,
        {
            { 0, IntColour(255, 216, 60, 255) },
            { 0.5, IntColour(255, 216, 60, 255) },
            { 1, IntColour(255, 216, 60, 0) },
        }
    )
