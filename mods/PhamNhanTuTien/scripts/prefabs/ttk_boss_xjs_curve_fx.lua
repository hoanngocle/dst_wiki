...
local COLOUR_ENVELOPE_NAME_SMOKE = "ttk_boss_xjs_curve_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "ttk_boss_xjs_curve_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "ttk_boss_xjs_curve_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "ttk_boss_xjs_curve_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_SPARK = "ttk_boss_xjs_curve_colourenvelope_spark"
local SCALE_ENVELOPE_NAME_SPARK = "ttk_boss_xjs_curve_scaleenvelope_spark"
local assets =
{
...
return Prefab("ttk_boss_xjs_curve_fx", fn, assets)
