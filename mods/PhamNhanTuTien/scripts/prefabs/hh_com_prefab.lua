local _bU_g__ = require "enums/hh_prefabs"
SetSharedLootTable("hh_treasure_monster", {{"hh_essence", 1}})
...
for b__U_g, __b__ug_ in pairs(_bU_g__) do
    ...
    if __b__ug_["xml"] then
        local __B_u_g_ = b__U_g
        RegisterInventoryItemAtlas(__b__ug_["xml"], __B_u_g_ .. ".tex")
    end
end
