...
local __b__UG_ = {
    ...
    ["damageBoostGem"] = {["name"] = "Đá sát thương"},
    ["powerMettleStone"] = {["name"] = "Đá sức mạnh"},
    ["followCritical"] = {["name"] = "Đá thú chí"},
    ["followDamage"] = {["name"] = "Đá thú sát"},
    ["followArmor"] = {["name"] = "Đá thú ngự"},
    ["shadowNightBead"] = {["name"] = "Đá tối"},
    ["twilightBead"] = {["name"] = "Đá chiều"},
    ["dayShineBead"] = {["name"] = "Đá sáng"},
    ["critStrikeStone"] = {["name"] = "Đá chí mạng"},
    ["resistDamageGem"] = {["name"] = "Đá giảm thương"},
    ["retaliateGem"] = {["name"] = "Đá phản đòn"},
    ["spiderVengeance"] = {["name"] = "Đá nhện"},
    ["insectStrikeCrystal"] = {["name"] = "Đá côn trùng"},
    ["shadowStrikeLuminary"] = {["name"] = "Đá bóng tối"},
    ["bossStrikeGem"] = {["name"] = "Đá Boss"},
