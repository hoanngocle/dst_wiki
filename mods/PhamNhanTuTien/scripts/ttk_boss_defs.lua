local bosses = {
    ...
    stalke_fuben = {name="Thượng Cổ Hắc Ám", food_name="Hắc Ám Hồn Tinh", summon_name="Tâm Nhĩ Hắc Ám", summon_icon="shadowheart", stat="absorbDamage", gain=2, effect="immunitySleep"},
