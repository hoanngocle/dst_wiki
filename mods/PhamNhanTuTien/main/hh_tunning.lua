...
TUNING["HH_FORMAT_CONFIG"] = {
    ["BUFF"] = {
        ...
        ["test_09"] = "",
        ["test_10"] = "",
        ["suit_yhby"] = "miễn nhiễm độc, ướt\nbổ sung khả năng hồi phục"
    },
    ["EQUIP_EFFECT"] = {
        ...
        ["reduce_damage"] = "giảm %s ST nhận vào",
        ["true_damage"] = "trừ %s máu mục tiêu khi tấn công",
        ["add_damage_small"] = "tăng %s ST",
        ["add_damage_med"] = "tăng %s ST",
        ["add_damage_big"] = "tăng %s ST",
        ["atk_add_poison"] = "tấn công có %s%% hạ độc mục tiêu\n(-5 máu/2s/60s)",
        ["add_night_damage"] = "tăng %s ST vào buổi đêm",
        ["add_day_damage"] = "tăng %s ST vào buổi ngày",
        ["add_dusk_damage"] = "tăng %s ST vào buổi chiều",
        ["add_moisture_damage"] = "tăng %s ST điện",
        ...
        ["reflexive_injury"] = "phản %s ST vào kẻ tấn công",
        ["add_hit_damage_pig"] = "tăng %s ST vào heo",
        ["add_hit_damage_fish"] = "tăng %s ST vào cá",
        ["add_hit_damage_monkey"] = "tăng %s ST vào khỉ",
        ["add_hit_damage_gear"] = "tăng %s ST vào quái đồng hồ",
        ["add_hit_damage_spider"] = "tăng %s ST vào nhện",
        ["add_hit_damage_dog"] = "tăng %s ST vào sói",
        ["add_hit_damage_frog"] = "tăng %s ST vào ếch",
        ["add_hit_damage_insect"] = "tăng %s ST vào côn trùng",
        ["add_hit_damage_shadow"] = "tăng %s ST vào quái hệ bóng tối",
        ["add_hit_damage_boss"] = "tăng %s ST vào quái trùm",
        ["add_hit_damage_plant"] = "tăng %s ST vào thực vật",
        ...
        ["atk_add_san"] = "%s%% ST gây ra hồi vào não khi tấn công",
        ...
        ["atk_10s_health"] = "tấn công có 10% kích hoạt hiệu ứng\nhồi 1 máu/s trong 120s",
        ["add_poisonProtection"] = "kháng độc %s%%",
        ["add_immune_poison"] = "miễn nhiễm trúng độc",
        ["add_immune_freeze"] = "miễn nhiễm đóng băng",
        ["san_replace_damage"] = "%s%% nhận ST trừ thẳng vào não",
        ["attack_fire_impact"] = "tấn công có %% tạo 5 xích diễm",
        ["reduce_bramble_percent"] = "giảm %s%% ST phản đòn nhận vào",
        ["immune_bramble"] = "miễn nhiễm ST từ phản đòn",
        ["follow_damage"] = "tăng %s ST cho quái đi theo",
        ["follow_reduce_damage"] = "giảm %s ST nhận vào cho quái đi theo",
        ["more_damage_30_150"] = "30%% gây %s%% ST chí mạng",
        ["more_damage_20_200"] = "20%% gây %s%% ST chí mạng",
        ["more_damage_15_300"] = "10%% gây %s%% ST chí mạng",
        ["more_damage_8_500"] = "8%% gây %s%% ST chí mạng",
        ["health_suppress_num"] = "có %s%% thiêu đốt mục tiêu khi tấn công",
        ...
        ["special_bhtg"] = "tăng 160 ST, gây trọng thương\n(trừ %s%% máu mục tiêu khi tấn công)",
        ["special_xwsh"] = "thiêu đốt mục tiêu, %s%% ST gây ra\nhồi máu và não khi tấn công",
        ["special_sgsy"] = "giảm 35 ST và 45%% ST nhận vào\nmiễn nhiễm thiêu đốt và phản đòn",
        ["atk_speed"] = "tăng %s%% tốc đánh",
        ["immune_sleep"] = "miễn nhiễm ru ngủ",
        ["immune_suppress"] = "miễn nhiễm thiêu đốt",
        ...
        ["z_suit_yhby"] = "Thánh Quang Tí Hựu",
        ["z_suit_bhtg"] = "Bạch Hổ Thiên Cương",
        ["z_suit_zqrf"] = "Chu Tước Loan Phụng",
        ["z_suit_xwsh"] = "Huyền Vũ Thủ Hộ",
        ["z_suit_slly"] = "Thanh Long Lăng Vân",
        ["z_suit_fyyy"] = "Phi Vân Dật Ảnh"
    },
    ["SUIT_CONFIG"] = {
        ["suit_yhby"] = {["name"] = "Thánh Quang Tí Hựu", ["desc"] = "", ["effect_str"] = ""},
        ["suit_bhtg"] = {["name"] = "Bạch Hổ Thiên Cương", ["desc"] = "", ["effect_str"] = ""},
        ["suit_zqrf"] = {["name"] = "Chu Tước Loan Phụng", ["desc"] = "", ["effect_str"] = ""},
        ["suit_fyyy"] = {["name"] = "Phi Vân Dật Ảnh", ["desc"] = "", ["effect_str"] = ""}
    },
    ["GEM_EFFECT"] = {
        ["durableGem"] = " Hồi 1 độ bền mỗi giây",
        ["damageBoostGem"] = " Tăng 20 ST",
        ["powerMettleStone"] = " Tăng 10% ST",
        ["strideBead"] = " Tăng 3% tốc chạy",
        ["treasure_fireGem"] = " Tăng 30% sát thương thiêu đốt",
        ["shadowNightBead"] = " Tăng 40 ST vào buổi đêm",
        ["twilightBead"] = " Tăng 40 ST vào buổi chiều",
        ["dayShineBead"] = " Tăng 40 ST vào buổi sáng",
        ["critStrikeStone"] = " Tăng 5% chí mạng",
        ["resistDamageGem"] = " Giảm 5 ST nhận vào",
        ["retaliateGem"] = " Phản 10 ST",
        ["spiderVengeance"] = " Tăng 40 ST vào nhện",
        ["insectStrikeCrystal"] = " Tăng 40 ST vào côn trùng",
        ["shadowStrikeLuminary"] = " Tăng 40 ST vào sinh vật bóng tối",
        ["bossStrikeGem"] = " Tăng 40 ST vào quái trùm",
    ...
    ["MONSTER_CONFIG"] = {
        ...
        ["addReboundDamageNum"] = " Phản %s ST",
        ["addDayDamage"] = " Tăng %s ST vào buổi sáng",
        ["addDuskDamage"] = " Tăng %s ST vào buổi chiều",
        ["addNightDamage"] = " Tăng %s ST vào buổi tối",
        ["addSuppressAddHealth"] = " Có %s%% thiêu đốt mục tiêu",
        ["hitSuppressAddHealth"] = " Có %s%% thiêu đốt kẻ tấn công",
        ["reboundDamagePercent"] = " Phản %s%% ST",
