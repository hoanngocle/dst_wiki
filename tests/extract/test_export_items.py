    ...
    def test_export_is_deterministic_and_atomic(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            export_items(
                ...
                category_artifact_path=root / "missing-category.json",
                category_crawl_path=root / "category-crawl",
                category_assets_path=root / "category-assets",
                category_audit_path=root / "category-audit.json",
